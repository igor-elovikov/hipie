...
float2 p1, p2;
float2 noise_pos = __sys_pixel_pos + woffset;
...
switch (distance_metric) {
    ...
    case 0:
        for (int i = 0; i < octaves; i++) {
            ...
            total_weight += weight;
            pvnoise2(seed, noise_pos, jitter, &cell_value, &f1, &f2, &p1, &p2, period);
    ...
    case 1:
        for (int i = 0; i < octaves; i++) {
            ...
            total_weight += weight;
            pmvnoise2(seed, noise_pos, jitter, &cell_value, &f1, &f2, &p1, &p2, period);
            float octave_value = 0.f;
    ...
    case 2:
        for (int i = 0; i < octaves; i++) {
            ...
            total_weight += weight;
            pcvnoise2(seed, noise_pos, jitter, &cell_value, &f1, &f2, &p1, &p2, period);
            float octave_value = 0.f;
    ...
    case 3:
        for (int i = 0; i < octaves; i++) {
            ...
            total_weight += weight;
            pmkvnoise2(seed, noise_pos, jitter, &cell_value, &f1, &f2, &p1, &p2, period, minkowksy_number);
            float octave_value = 0.f;
